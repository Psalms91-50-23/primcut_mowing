        ...
        >
          ...
          <div className="relative" ref={servicesDropdownRef}>
            ...
            <button
              ...
              className="w-full border rounded-lg px-4 py-2 text-left bg-white focus:outline-none focus:ring-0 flex items-center justify-between"
            >
              <span
                className={
                ...
                {services.length > 0 ? (
                  services.map((service) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={form.services.includes(service.code)}
